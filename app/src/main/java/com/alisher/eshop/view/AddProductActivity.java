...
import com.alisher.eshop.databinding.ActivityAddProductBinding;
import com.alisher.eshop.storage.LoginUtils;
import com.alisher.eshop.viewmodel.AddProductViewModel;
...
public class AddProductActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void addProduct(String pathname) {
        ...
        String descString = binding.txtDesc.getText().toString().trim();
        ...
        // Zkontrolovat zda nejsou prazdne hodnoty
        ...
        if (categoryString.equals("oblečení")){
            categoryString = "clothes";
        } if (categoryString.equals("kosmetika")){
            categoryString = "cosmetics";
        }
        Log.i("Category: ", categoryString);

        Map<String, RequestBody> map = new HashMap<>();
        map.put("name", toRequestBody(nameString));
        map.put("desc", toRequestBody(descString));
