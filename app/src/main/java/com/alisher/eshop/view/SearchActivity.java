...
import com.alisher.eshop.adapter.WordAdapter;
import com.alisher.eshop.databinding.ActivitySearchBinding;
...
public class SearchActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Vrati zobrazeni hodnot obsazenych v mape
    ...
    public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        adapter.remove(word);
        Toast.makeText(this, "Odebráno", Toast.LENGTH_SHORT).show();
        return true;
    }
