package com.alisher.eshop.model;
...
public class Product implements Parcelable {
    ...
    public Product(String productName, String productDetail, double productPrice, int productQuantity, String productSupplier, String productCategory) {
