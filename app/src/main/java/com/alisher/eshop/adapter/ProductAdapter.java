package com.alisher.eshop.adapter;

import static com.alisher.eshop.utils.Constant.LOCALHOST;
import static com.alisher.eshop.utils.Utils.shareProduct;
...
import com.alisher.eshop.databinding.ProductListItemBinding;
...
import com.alisher.eshop.viewmodel.AddFavoriteViewModel;
import com.alisher.eshop.viewmodel.FromCartViewModel;
import com.alisher.eshop.viewmodel.RemoveFavoriteViewModel;
import com.alisher.eshop.viewmodel.ToCartViewModel;
import com.alisher.eshop.viewmodel.ToHistoryViewModel;
...
public class ProductAdapter extends PagedListAdapter<Product, ProductAdapter.ProductViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        ...
        if (product != null) {
            ...
            holder.binding.txtProductPrice.setText(formattedPrice + " CZK");
            ...
            Toast.makeText(mContext, "Produkt je neplatný", Toast.LENGTH_LONG).show();
        }
    }
